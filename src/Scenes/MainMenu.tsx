...
export function MainMenu() {
	...
	return (
		<div className="min-h-screen w-full bg-jungle-night bg-noise bg-blend-overlay flex items-center justify-center p-4 animate-heat-wave">
			...
			<div className="max-w-2xl w-full bg-jungle-dark/90 border-2 border-olive-drab shadow-haze backdrop-blur-sm">
				{/* Header: Main Title */}
				<div className="bg-olive-drab border-b-2 border-canvas-tan p-6 text-center relative">
					<div className="absolute inset-0 bg-noise opacity-20 pointer-events-none" />
					<h1 className="font-stencil text-stencil-lg text-chalk-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)] tracking-widest relative z-10">
						OTTER
						<br />
						ELITE FORCE
					</h1>
