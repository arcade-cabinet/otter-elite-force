...
export function Card({ className, ...props }: ComponentPropsWithoutRef<"div">) {
	return (
		<div
			className={cn(
				"rounded-lg border border-border/90 bg-card/92 text-card-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_18px_36px_rgba(0,0,0,0.22)] backdrop-blur-sm",
				className,
			)}
			{...props}
		/>
