...
const TILE_PATHS: Record<string, string> = {
	...
	grass_fill: BASE + "assets/tiles/terrain/grass_fill.png",
	grass_fill_2: BASE + "assets/tiles/terrain/grass_fill_2.png",
	grass_dark_fill: BASE + "assets/tiles/terrain/grass_dark_fill.png",
	grass_dark_fill_2: BASE + "assets/tiles/terrain/grass_dark_fill_2.png",
	dirt_fill: BASE + "assets/tiles/terrain/dirt_fill.png",
	dirt_fill_2: BASE + "assets/tiles/terrain/dirt_fill_2.png",
	mud_fill: BASE + "assets/tiles/terrain/mud_fill.png",
	beach_fill: BASE + "assets/tiles/terrain/beach_fill.png",
	beach_fill_2: BASE + "assets/tiles/terrain/beach_fill_2.png",
	water_fill: BASE + "assets/tiles/terrain/water_fill.png",
	water_fill_2: BASE + "assets/tiles/terrain/water_fill_2.png",
	bridge_fill: BASE + "assets/tiles/terrain/bridge_fill.png",

	// ── Blend transition tiles (procedurally generated, exact fill colors) ──
	// grass <-> water (riverbanks)
	blend_grass_water_tl: BASE + "assets/tiles/terrain/blend_grass_water_tl.png",
	blend_grass_water_t: BASE + "assets/tiles/terrain/blend_grass_water_t.png",
	blend_grass_water_tr: BASE + "assets/tiles/terrain/blend_grass_water_tr.png",
	blend_grass_water_l: BASE + "assets/tiles/terrain/blend_grass_water_l.png",
	blend_grass_water_r: BASE + "assets/tiles/terrain/blend_grass_water_r.png",
	blend_grass_water_bl: BASE + "assets/tiles/terrain/blend_grass_water_bl.png",
	blend_grass_water_b: BASE + "assets/tiles/terrain/blend_grass_water_b.png",
	blend_grass_water_br: BASE + "assets/tiles/terrain/blend_grass_water_br.png",
	blend_water_grass_tl: BASE + "assets/tiles/terrain/blend_water_grass_tl.png",
	blend_water_grass_t: BASE + "assets/tiles/terrain/blend_water_grass_t.png",
	blend_water_grass_tr: BASE + "assets/tiles/terrain/blend_water_grass_tr.png",
	blend_water_grass_l: BASE + "assets/tiles/terrain/blend_water_grass_l.png",
	blend_water_grass_r: BASE + "assets/tiles/terrain/blend_water_grass_r.png",
	blend_water_grass_bl: BASE + "assets/tiles/terrain/blend_water_grass_bl.png",
	blend_water_grass_b: BASE + "assets/tiles/terrain/blend_water_grass_b.png",
	blend_water_grass_br: BASE + "assets/tiles/terrain/blend_water_grass_br.png",
	// grass <-> beach (coastline)
	blend_grass_beach_tl: BASE + "assets/tiles/terrain/blend_grass_beach_tl.png",
	blend_grass_beach_t: BASE + "assets/tiles/terrain/blend_grass_beach_t.png",
	blend_grass_beach_tr: BASE + "assets/tiles/terrain/blend_grass_beach_tr.png",
	blend_grass_beach_l: BASE + "assets/tiles/terrain/blend_grass_beach_l.png",
	blend_grass_beach_r: BASE + "assets/tiles/terrain/blend_grass_beach_r.png",
	blend_grass_beach_bl: BASE + "assets/tiles/terrain/blend_grass_beach_bl.png",
	blend_grass_beach_b: BASE + "assets/tiles/terrain/blend_grass_beach_b.png",
	blend_grass_beach_br: BASE + "assets/tiles/terrain/blend_grass_beach_br.png",
	blend_beach_grass_tl: BASE + "assets/tiles/terrain/blend_beach_grass_tl.png",
	blend_beach_grass_t: BASE + "assets/tiles/terrain/blend_beach_grass_t.png",
	blend_beach_grass_tr: BASE + "assets/tiles/terrain/blend_beach_grass_tr.png",
	blend_beach_grass_l: BASE + "assets/tiles/terrain/blend_beach_grass_l.png",
	blend_beach_grass_r: BASE + "assets/tiles/terrain/blend_beach_grass_r.png",
	blend_beach_grass_bl: BASE + "assets/tiles/terrain/blend_beach_grass_bl.png",
	blend_beach_grass_b: BASE + "assets/tiles/terrain/blend_beach_grass_b.png",
	blend_beach_grass_br: BASE + "assets/tiles/terrain/blend_beach_grass_br.png",
	// grass <-> dirt
	blend_grass_dirt_tl: BASE + "assets/tiles/terrain/blend_grass_dirt_tl.png",
	blend_grass_dirt_t: BASE + "assets/tiles/terrain/blend_grass_dirt_t.png",
	blend_grass_dirt_tr: BASE + "assets/tiles/terrain/blend_grass_dirt_tr.png",
	blend_grass_dirt_l: BASE + "assets/tiles/terrain/blend_grass_dirt_l.png",
	blend_grass_dirt_r: BASE + "assets/tiles/terrain/blend_grass_dirt_r.png",
	blend_grass_dirt_bl: BASE + "assets/tiles/terrain/blend_grass_dirt_bl.png",
	blend_grass_dirt_b: BASE + "assets/tiles/terrain/blend_grass_dirt_b.png",
	blend_grass_dirt_br: BASE + "assets/tiles/terrain/blend_grass_dirt_br.png",
	blend_dirt_grass_tl: BASE + "assets/tiles/terrain/blend_dirt_grass_tl.png",
	blend_dirt_grass_t: BASE + "assets/tiles/terrain/blend_dirt_grass_t.png",
	blend_dirt_grass_tr: BASE + "assets/tiles/terrain/blend_dirt_grass_tr.png",
	blend_dirt_grass_l: BASE + "assets/tiles/terrain/blend_dirt_grass_l.png",
	blend_dirt_grass_r: BASE + "assets/tiles/terrain/blend_dirt_grass_r.png",
	blend_dirt_grass_bl: BASE + "assets/tiles/terrain/blend_dirt_grass_bl.png",
	blend_dirt_grass_b: BASE + "assets/tiles/terrain/blend_dirt_grass_b.png",
	blend_dirt_grass_br: BASE + "assets/tiles/terrain/blend_dirt_grass_br.png",
	// grass <-> mud
	blend_grass_mud_tl: BASE + "assets/tiles/terrain/blend_grass_mud_tl.png",
	blend_grass_mud_t: BASE + "assets/tiles/terrain/blend_grass_mud_t.png",
	blend_grass_mud_tr: BASE + "assets/tiles/terrain/blend_grass_mud_tr.png",
	blend_grass_mud_l: BASE + "assets/tiles/terrain/blend_grass_mud_l.png",
	blend_grass_mud_r: BASE + "assets/tiles/terrain/blend_grass_mud_r.png",
	blend_grass_mud_bl: BASE + "assets/tiles/terrain/blend_grass_mud_bl.png",
	blend_grass_mud_b: BASE + "assets/tiles/terrain/blend_grass_mud_b.png",
	blend_grass_mud_br: BASE + "assets/tiles/terrain/blend_grass_mud_br.png",
	blend_mud_grass_tl: BASE + "assets/tiles/terrain/blend_mud_grass_tl.png",
	blend_mud_grass_t: BASE + "assets/tiles/terrain/blend_mud_grass_t.png",
	blend_mud_grass_tr: BASE + "assets/tiles/terrain/blend_mud_grass_tr.png",
	blend_mud_grass_l: BASE + "assets/tiles/terrain/blend_mud_grass_l.png",
	blend_mud_grass_r: BASE + "assets/tiles/terrain/blend_mud_grass_r.png",
	blend_mud_grass_bl: BASE + "assets/tiles/terrain/blend_mud_grass_bl.png",
	blend_mud_grass_b: BASE + "assets/tiles/terrain/blend_mud_grass_b.png",
	blend_mud_grass_br: BASE + "assets/tiles/terrain/blend_mud_grass_br.png",
	// grass <-> mangrove
	blend_grass_mangrove_tl: BASE + "assets/tiles/terrain/blend_grass_mangrove_tl.png",
	blend_grass_mangrove_t: BASE + "assets/tiles/terrain/blend_grass_mangrove_t.png",
	blend_grass_mangrove_tr: BASE + "assets/tiles/terrain/blend_grass_mangrove_tr.png",
	blend_grass_mangrove_l: BASE + "assets/tiles/terrain/blend_grass_mangrove_l.png",
	blend_grass_mangrove_r: BASE + "assets/tiles/terrain/blend_grass_mangrove_r.png",
	blend_grass_mangrove_bl: BASE + "assets/tiles/terrain/blend_grass_mangrove_bl.png",
	blend_grass_mangrove_b: BASE + "assets/tiles/terrain/blend_grass_mangrove_b.png",
	blend_grass_mangrove_br: BASE + "assets/tiles/terrain/blend_grass_mangrove_br.png",
	blend_mangrove_grass_tl: BASE + "assets/tiles/terrain/blend_mangrove_grass_tl.png",
	blend_mangrove_grass_t: BASE + "assets/tiles/terrain/blend_mangrove_grass_t.png",
	blend_mangrove_grass_tr: BASE + "assets/tiles/terrain/blend_mangrove_grass_tr.png",
	blend_mangrove_grass_l: BASE + "assets/tiles/terrain/blend_mangrove_grass_l.png",
	blend_mangrove_grass_r: BASE + "assets/tiles/terrain/blend_mangrove_grass_r.png",
	blend_mangrove_grass_bl: BASE + "assets/tiles/terrain/blend_mangrove_grass_bl.png",
	blend_mangrove_grass_b: BASE + "assets/tiles/terrain/blend_mangrove_grass_b.png",
	blend_mangrove_grass_br: BASE + "assets/tiles/terrain/blend_mangrove_grass_br.png",
	// water <-> beach (shoreline)
	blend_water_beach_tl: BASE + "assets/tiles/terrain/blend_water_beach_tl.png",
	blend_water_beach_t: BASE + "assets/tiles/terrain/blend_water_beach_t.png",
	blend_water_beach_tr: BASE + "assets/tiles/terrain/blend_water_beach_tr.png",
	blend_water_beach_l: BASE + "assets/tiles/terrain/blend_water_beach_l.png",
	blend_water_beach_r: BASE + "assets/tiles/terrain/blend_water_beach_r.png",
	blend_water_beach_bl: BASE + "assets/tiles/terrain/blend_water_beach_bl.png",
	blend_water_beach_b: BASE + "assets/tiles/terrain/blend_water_beach_b.png",
	blend_water_beach_br: BASE + "assets/tiles/terrain/blend_water_beach_br.png",
	blend_beach_water_tl: BASE + "assets/tiles/terrain/blend_beach_water_tl.png",
	blend_beach_water_t: BASE + "assets/tiles/terrain/blend_beach_water_t.png",
	blend_beach_water_tr: BASE + "assets/tiles/terrain/blend_beach_water_tr.png",
	blend_beach_water_l: BASE + "assets/tiles/terrain/blend_beach_water_l.png",
	blend_beach_water_r: BASE + "assets/tiles/terrain/blend_beach_water_r.png",
	blend_beach_water_bl: BASE + "assets/tiles/terrain/blend_beach_water_bl.png",
	blend_beach_water_b: BASE + "assets/tiles/terrain/blend_beach_water_b.png",
	blend_beach_water_br: BASE + "assets/tiles/terrain/blend_beach_water_br.png",
	// dirt <-> beach (sandy trails)
	blend_dirt_beach_tl: BASE + "assets/tiles/terrain/blend_dirt_beach_tl.png",
	blend_dirt_beach_t: BASE + "assets/tiles/terrain/blend_dirt_beach_t.png",
	blend_dirt_beach_tr: BASE + "assets/tiles/terrain/blend_dirt_beach_tr.png",
	blend_dirt_beach_l: BASE + "assets/tiles/terrain/blend_dirt_beach_l.png",
	blend_dirt_beach_r: BASE + "assets/tiles/terrain/blend_dirt_beach_r.png",
	blend_dirt_beach_bl: BASE + "assets/tiles/terrain/blend_dirt_beach_bl.png",
	blend_dirt_beach_b: BASE + "assets/tiles/terrain/blend_dirt_beach_b.png",
	blend_dirt_beach_br: BASE + "assets/tiles/terrain/blend_dirt_beach_br.png",
	blend_beach_dirt_tl: BASE + "assets/tiles/terrain/blend_beach_dirt_tl.png",
	blend_beach_dirt_t: BASE + "assets/tiles/terrain/blend_beach_dirt_t.png",
	blend_beach_dirt_tr: BASE + "assets/tiles/terrain/blend_beach_dirt_tr.png",
	blend_beach_dirt_l: BASE + "assets/tiles/terrain/blend_beach_dirt_l.png",
	blend_beach_dirt_r: BASE + "assets/tiles/terrain/blend_beach_dirt_r.png",
	blend_beach_dirt_bl: BASE + "assets/tiles/terrain/blend_beach_dirt_bl.png",
	blend_beach_dirt_b: BASE + "assets/tiles/terrain/blend_beach_dirt_b.png",
	blend_beach_dirt_br: BASE + "assets/tiles/terrain/blend_beach_dirt_br.png",

	// ── Bridge ──
	bridge_h: BASE + "assets/tiles/terrain/bridge_h.png",
	bridge_v: BASE + "assets/tiles/terrain/bridge_v.png",

	// ── Path ──
	path_h: BASE + "assets/tiles/terrain/path_h.png",
	path_v: BASE + "assets/tiles/terrain/path_v.png",

	// ── Props ──
	tree_pine_sm: BASE + "assets/tiles/props/tree_pine_sm.png",
	tree_pine_lg: BASE + "assets/tiles/props/tree_pine_lg.png",
	tree_round_sm: BASE + "assets/tiles/props/tree_round_sm.png",
	tree_round_lg: BASE + "assets/tiles/props/tree_round_lg.png",
	tree_cluster_1: BASE + "assets/tiles/props/tree_cluster_1.png",
	tree_tall_1: BASE + "assets/tiles/props/tree_tall_1.png",
	tree_tall_2: BASE + "assets/tiles/props/tree_tall_2.png",
	rock_gray_1: BASE + "assets/tiles/props/rock_gray_1.png",
	rock_gray_2: BASE + "assets/tiles/props/rock_gray_2.png",
	rock_cluster: BASE + "assets/tiles/props/rock_cluster.png",
	bush_green: BASE + "assets/tiles/props/bush_green.png",
	mushroom: BASE + "assets/tiles/props/mushroom.png",
	stump: BASE + "assets/tiles/props/stump.png",
	forest_sparse: BASE + "assets/tiles/props/forest_sparse.png",
	forest_dense_1: BASE + "assets/tiles/props/forest_dense_1.png",
	forest_dense_2: BASE + "assets/tiles/props/forest_dense_2.png",
	forest_full: BASE + "assets/tiles/props/forest_full.png",
};
